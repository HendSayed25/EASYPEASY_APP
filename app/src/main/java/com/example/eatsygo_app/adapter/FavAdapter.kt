...
class FavAdapter(private var favList:List<ProductEntity>):RecyclerView.Adapter<FavAdapter.FavViewHolder>() {
    class FavViewHolder(private var binding:FavItemDesignBinding,
                        private val onItemClicked: OnItemClickFav?) :RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavViewHolder {
        val binding = FavItemDesignBinding.inflate(LayoutInflater.from(parent.context), parent, false)
